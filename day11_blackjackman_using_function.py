...
def user_choices(sum,user_choice):
    user_choice_variable = random.choice(list_1)
    user_choice.append(user_choice_variable)
    sum+= user_choice_variable
    return (sum,user_choice)
def computer_choices(computer_sum,computer_choice):
    ...
    return (computer_sum,computer_choice)
...
if sum == 21 and computer_choice[0] < 21:
    ...
    while continue_1 ==True:    
        ...
        if repeat == "yes":
            ...
            continue_1 = False
computer_choices(computer_sum,computer_choice)
